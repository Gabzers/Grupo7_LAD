...
class MLPAnalysis:
    def __init__(self, X_train, X_test, y_train, y_test, le, hidden_layer_sizes=(50,), name="Neural Net", use_pca=True, n_components=10, use_clustering=True, n_clusters=5):
    ...
    def apply_clustering(self):
        ...
        if self.use_clustering:
            ...
            print("Cluster_id adicionado como nova feature para MLP.")
...
if __name__ == "__main__":
    ...
    print("Treinando modelo MLP (Neural Network)...")
    # Instanciar e executar análise com clustering
    analysis = MLPAnalysis(X_train_scaled, X_test_scaled, y_train, y_test, le, use_pca=True, use_clustering=True)
    analysis.run()
