...
class LinearRegressionAnalysis:
    ...
    def apply_clustering(self):
        ...
        if self.use_clustering:
            ...
            print("Cluster_id adicionado como nova feature para Linear Regression.")
...
if __name__ == "__main__":
    ...
    analysis = LinearRegressionAnalysis(X_train_scaled, X_test_scaled, y_train, y_test, le, use_pca=True, use_clustering=True)
    analysis.run()
