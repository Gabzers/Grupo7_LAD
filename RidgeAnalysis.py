...
class RidgeAnalysis:
    def __init__(self, X_train, X_test, y_train, y_test, le, alpha=1.0, use_pca=True, n_components=10, use_clustering=True, n_clusters=5):
    ...
    def apply_clustering(self):
        ...
        if self.use_clustering:
            ...
            print("Cluster_id adicionado como nova feature para Ridge.")
    ...
    def run(self):
        ...
        plt.title(f"Matriz de Confusão: Ridge (alpha={self.alpha})")
        plt.xlabel("Predito")
...
if __name__ == "__main__":
    ...
    analysis = RidgeAnalysis(X_train_scaled, X_test_scaled, y_train, y_test, le, use_pca=True, use_clustering=True)
    analysis.run()
